...
class TaskAlignedAssigner(nn.Module):
    ...
    def iou_calculation(self, gt_bboxes, pd_bboxes):
        ...
        # return shape_iou(gt_bboxes, pd_bboxes).squeeze(-1).clamp_(0)  #shape_iou
        # return bbox_iou(gt_bboxes, pd_bboxes, xywh=False).squeeze(-1).clamp(0) #Wiou
        # return bbox_iou(gt_bboxes, pd_bboxes, xywh=False, MPDIoU=True).squeeze(-1).clamp(0) #
        # return bbox_iou(gt_bboxes, pd_bboxes, xywh=False, LMPDIoU=True).squeeze(-1).clamp(0)
