...
from ultralytics.nn.modules import (
    ...
    Segment,
    WorldDetect,
    v10Detect,Concat_BiFPN, BiFPN_Concat2, BiFPN_Concat3
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  
        ...
        if m in {
            ...
            C2fCIB,
            PConv, SCDown, ADown, 
             ADown, C2PSA_LSKA, C2PSA_iRMB,
             C2PSA_QLSKA,  RepNCSPELAN4, SPPELAN
             }:
            c1, c2 = ch[f], args[0]
            ...
            if m in {
                ...
                C2fPSA,
                C2fCIB,
                C2PSA, C2PSA_LSKA, C2PSA_QLSKA, 

                # C3k2_DynamicConv,Bottleneck_Context
            }:
            ...
            if m is C3k2 and scale in "mlx":  # for M/L/X sizes
                args[3] = True
                #--------注意力機制---------------
        elif m in { iRMB, QLSKA,  QiRMB, QQiRMB
                  }:
            c2 = ch[f]
            args = [c2, *args]
        elif m is SDI:
            args = [[ch[x] for x in f]]
                ...
                #--------主幹--------------- 
        elif m in {repvit_m0_6, repvit_m0_9, repvit_m1_0, repvit_m1_1, repvit_m1_5, repvit_m2_3, qrepvit_m0_6
                  }:
            m = m(*args)
            c2 = m.width_list  # 返回通道列表
            backbone = True
                #--------主幹---------------    
        elif m in [BiFPN_Concat2,BiFPN_Concat3, Concat_BiFPN]:
