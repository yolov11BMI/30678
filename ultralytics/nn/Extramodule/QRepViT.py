...
__all__ = ['qrepvit_m0_6','qrepvit_m0_9', 'qrepvit_m1_0', 'qrepvit_m1_1', 'qrepvit_m1_5', 'qrepvit_m2_3']

# Utility function to make channel number divisible
...
# Placeholder for Quantum Convolution and Quantum Rotation Gate
class QuantumConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0):
        super(QuantumConv2d, self).__init__()
        # Define the quantum convolution operation here
        # This is a placeholder and needs to be replaced with actual QCNN implementation
        self.qconv = nn.Conv2d(in_channels, out_channels, kernel_size, stride, padding, bias=False)
...
class QuantumRotationGate(nn.Module):
    def __init__(self, in_channels):
        super(QuantumRotationGate, self).__init__()
...
class Conv2d_BN(torch.nn.Sequential):
    def __init__(self, a, b, ks=1, stride=1, pad=0, dilation=1,
        ...
        super().__init__()
        # Use QuantumConv2d if kernel size is not 1x1
        if ks != 1:
            self.add_module('c', QuantumConv2d(a, b, ks, stride, pad))
        else:
...
class RepVGGDW(torch.nn.Module):
    def __init__(self, ed) -> None:
        ...
        self.qrotation = QuantumRotationGate(ed)

    def forward(self, x):
        x = self.bn((self.conv(x) + self.conv1(x)) + x)
        return self.qrotation(x)
...
if __name__ == '__main__':
    model = qrepvit_m0_6(factor=0.25)
